class SDCImpactDistribution extends standardChildView {
    ...
    constructor(svg, x, y, width, height, data, maxSDCImpact, minSDCImpact, threshold) {
    ...
    draw() {
        ...
        let colorscale = d3.scaleQuantize().domain([0, d3.sum(this.hist, (d) => {
            return d.length
        })]).range(this.outcomeColor);
