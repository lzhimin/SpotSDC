...
experiment = pd.read_csv("injectlog.log",  sep=' ', names=['file', 'linenum', 'variable', 'byte_num',
                                                           'corrupted', 'init_value', 'to', 'corrupt_value', 'mask', 'byte', 'expo', 'ss', 'op', 'diffnorm', 'empty'])
...
result_data_set = pd.DataFrame(result_data_set, columns=[
                               "File_index", "Function", "Line", "Variable", "out_xor", "out_xor_relative", "diffnormr", "outcome", "iter", "bit", "DI"])
